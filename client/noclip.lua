...
ToggleNoClip = function(state)
    ...
    KGCore.Functions.Notify(IsNoClipping and Lang:t('success.noclip_enabled') or Lang:t('success.noclip_disabled'))
...
RegisterNetEvent('kg-admin:client:ToggleNoClip', function()
